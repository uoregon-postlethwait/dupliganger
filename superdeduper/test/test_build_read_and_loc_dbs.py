...
from superdeduper.build_read_and_loc_dbs import __doc__
from superdeduper.build_read_and_loc_dbs import run, parse_args
...
# e.g. 'superdeduper/test/files/last_run/build_read_and_loc_dbs'
OUTFILE_DIR = os.path.join(BASE_OUTFILE_DIR, COMMAND_BEING_TESTED)

# e.g. 'superdeduper/test/files/build_read_and_loc_dbs/in'
