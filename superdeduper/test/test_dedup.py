...
from superdeduper.dedup import __doc__
from superdeduper.dedup import run, parse_args
...
# e.g. 'superdeduper/test/files/last_run/dedup'
OUTFILE_DIR = os.path.join(BASE_OUTFILE_DIR, COMMAND_BEING_TESTED)

# e.g. 'superdeduper/test/files/dedup/in'
