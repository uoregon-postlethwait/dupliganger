# Copyright (C) 2016, 2017 Jason Sydes
#
...
from superdeduper.barcode_split_quality_filter_umi_anno import __doc__
from superdeduper.barcode_split_quality_filter_umi_anno import run, parse_args
...
# e.g. 'superdeduper/test/files/last_run/barcode_split_quality_filter_umi_anno'
OUTFILE_DIR = os.path.join(BASE_OUTFILE_DIR, COMMAND_BEING_TESTED)

# e.g. 'superdeduper/test/files/barcode_split_quality_filter_umi_anno/in'
